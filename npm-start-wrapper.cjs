/**
 * Wrapper script for npm start that redirects to development mode
 */
...
log(`${colors.bright}Starting ScootMe application in development mode...${colors.reset}`, colors.magenta);
